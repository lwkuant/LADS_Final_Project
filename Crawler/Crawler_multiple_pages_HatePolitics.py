...
for page in range(177, 219):
    payload = {"from":"/bbs/HatePolitics/index"+str(page)+".html", "yes":"yes"}
    rs = requests.session()
    res = rs.post("https://www.ptt.cc/ask/over18", verify = False, data = payload)
    res = rs.get("https://www.ptt.cc/bbs/HatePolitics/index"+str(page)+".html", verify = False)
...
ptt_url_list_file = open("ptt_url_list_file_HatePolitics.txt", "w")
