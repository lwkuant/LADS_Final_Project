...
url = open("ptt_url_list_file_Gossiping.txt")
...
ptt_Gossiping_article = open("ptt_Gossiping_article.txt", "w",errors='ignore')
ptt_Gossiping_article.writelines(article_list)
ptt_Gossiping_article.close()
